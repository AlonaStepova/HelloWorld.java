...
public class SalaryCalculator {
    public static void main (String [] args){
        ...
        String taxReport = "Tax Rate Info: \n\tState tax rate: " + stateTaxRate + "\n\tFederal tax rate: "
                ...
                + stateTax + " is for state tax and tax amount $"
                + federalTax + " is for federal tax.\nAfter all these taxes, your total tax is $"
                + totalTax + " and your after tax salary is $" + salaryAfterTax;
