...
public class Groups {
    public static void main(String[] args) {
        ...
        String [][] groups2 = new String[4][3]; // 2D array will hold total 4 SINGLE dimensional arrays, which will have 3 elements on each
        System.out.println(Arrays.deepToString(groups2));

        System.out.println();
        String [][] groups = new String[4][]; // 2D array will hold total 4 SINGLE dimensional arrays
