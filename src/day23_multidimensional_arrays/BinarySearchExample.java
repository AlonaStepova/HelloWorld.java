...
public class BinarySearchExample {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.binarySearch(arr, 50)); // result is -4 because Array is not sorted
        System.out.println(Arrays.binarySearch(arr, 200)); // would be in position 5 +1=6, since it's not there --> * -1
